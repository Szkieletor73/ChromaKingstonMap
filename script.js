...
function namer(a) {
	...
	switch (a) {
		...
		case "raiders":
		  ...
		  description = "A snowy and rather inhospitable land that takes its name from the great peak which dominates the centre of its shores, Raider’s Pinnacle is often dull throughout the tundra that litters the ground, yet beautiful when one reaches the peak of its namesake: The treacherous mountain known as Raider’s Pinnacle. A lot has changed in the territory of Raider’s Pinnacle since the beginning of the great wars which have enveloped Chroma. A city known as Owanka sits inside the forests at the base of the mountain which despite the almost untouched surrounding environment, seems to be bustling with life and culture. Various settlements now litter the ground around Owanka, and rare abandoned outposts can be found below the peak as the two kingdoms have found the territory to be quite a stronghold in their ongoing feud.<br>The climate still reigns with an iron fist over the mountains, and amidst it an array of obscure and formerly undocumented creatures can be found. Due to the perilous slope of the mountain and the extremely taxing climate, few are either brave or stupid enough to climb the peak, and even fewer have the determination to return from it. However, if one were to reach the peak of the mountain, they would find an awe-inspiring mountain that provides a picturesque view over the territories of Chroma. Cutter, a poet who has been to the peak and returned almost at a loss to his own life and sanity wrote, “One can see it all, on the Owanka Peak. Above the whole war.” A series of old Orangered settlements seem to occupy the eastern side of the island, and although decrepit, they await the return of the army which once occupied it with long forgotten armaments and artefacts of a war waged and lost long ago.<br>The corpses of the mountain’s victims and creatures alike may be preserved for many hundreds of years at a time amidst the icy peak, and so often a climber may have to climb over the bodies of the deceased to reach the peak. This makes the journey not only physically taxing, but psychologically destructive on those unaccustomed to death. Those who make it back alive are never quite the same, having been exposed to the corpses of friends and foes and becoming so close to joining them, and so often those who reach the peak are unable to speak of their experience.<br>However, from the tales of those who return with their bodies intact, it is said that beyond yet below the peak of the mountain in a valley near the peak lies a beautiful utopia, shielded from the elements by the walls of the mountain itself and untouched by mankind. Little is known of the valley, but those who return state that it is the Garden of Eden. However, it will take a daring soul ready to persevere through the elements in order to discover whether this description is adequate, or simply the drivel of those driven to insanity.";
